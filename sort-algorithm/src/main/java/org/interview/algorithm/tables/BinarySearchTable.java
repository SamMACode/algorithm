package org.interview.algorithm.tables;
...
public class BinarySearchTable<Key extends Comparable<Key>, Value> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BinarySearchTable.class);
    ...
    /*public static void main(String[] args) {
        ...
        st.put("hello", 3);
        st.put("hello", 4);
        logger.info("hello对应的值为: {}", st.get("hello"));
    }*/
